...
local setup = function()
  ...
  local attach_func = function(client, bufnr)
    -- LSP mappings
    -- map("n", "gd", vim.lsp.buf.definition, { desc = "LSP go to definition of the symbol under the cursor." })
    ...
    -- map("n", "gi", vim.lsp.buf.implementation, { desc = "LSP go to implementation of the symbol under the cursor." })
