# source https://gist.github.com/kamui545/c810eccf6281b33a53e094484247f5e8
...
function set_dock {
    ...
    add_app_to_dock "/System/Cryptexes/App/System/Applications/Safari.app"
    add_small_spacer_to_dock 
    ...
    add_folder_to_dock "/Users/brian.tracey/Downloads" -a 2 -d 1 -v 1
...
function custom_screenshots_dir {
